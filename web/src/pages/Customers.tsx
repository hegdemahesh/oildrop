...
const Customers: React.FC = () => {
  ...
  // Toast not currently used in this refactored page (SaleModal handles its own toasts)
  ...
  // inventory subscription moved inside SaleModal
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-slate-100">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 flex flex-col gap-8">
        ...
        {showSaleFor && (
          <SaleModal open={!!showSaleFor} onClose={closeSale} customer={{ id: showSaleFor.id, name: showSaleFor.name, balance: showSaleFor.balance }} />
        )}
      </main>
    </div>
  );
